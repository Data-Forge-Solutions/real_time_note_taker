...
impl ThemeName {
    ...
    pub fn display_name(self) -> &'static str {
        match self {
            ...
            Self::TropicSignal => "Tropic Signal",
    ...
    pub fn theme(self) -> Theme {
        match self {
            ...
            Self::TropicSignal => Theme {
                ...
                input_title: Color::LightMagenta,
                help_key: Color::LightMagenta,
                help_desc: Color::LightGreen,
                overlay_border: Color::LightMagenta,
                overlay_title: Color::LightGreen,
                overlay_highlight_bg: Color::LightMagenta,
                overlay_highlight_fg: Color::LightGreen,
                editing_fg: Color::LightGreen,
                overlay_text: Color::LightMagenta,
            },
